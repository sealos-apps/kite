...
func TestBuildResourceUsageQueriesWithNamespaceScopedCluster(t *testing.T) {
	cpuQuery, memoryQuery, networkInQuery, networkOutQuery := buildResourceUsageQueries("node-a", "instance", "ns-a")
...
func TestBuildResourceUsageQueriesWithoutNamespaceOrInstance(t *testing.T) {
	cpuQuery, memoryQuery, networkInQuery, networkOutQuery := buildResourceUsageQueries("", "instance", "")
